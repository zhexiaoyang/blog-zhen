    ...
    a(document).ready(function() {
        ...
        a.fn.postLike = function() {
            ...
            if(saveid != null)
            {
                ...
                {
                    if(saveids[i]==z && hasid) continue;
                    else {
                        if(saveids[i]==z && !hasid) hasid = true;
        ...
        a("#commentform").submit(function() {
            ...
            a.ajax({
                ...
                success: function(B) {
                    ...
                    new_htm = (z == "0") ? ('\n<ol style="clear:both;padding:20px;font-size: 16px;" class="commentlist commentnew' + new_htm + "ol>") : ('\n<ul class="children' + new_htm + "ul>");
                    ...
                    a("#new_comm_" + k).hide().append(B + '。您的评论正在审核中，请稍后！');
